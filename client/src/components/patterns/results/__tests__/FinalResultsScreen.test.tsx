...
describe('FinalResultsScreen', () => {
  ...
  it('renders the podium, full standings, and action buttons', () => {
    render(<FinalResultsScreen players={mockPlayers} onPlayAgain={onPlayAgain} onExit={onExit} />);
