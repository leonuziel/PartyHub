...
export class ConfigurableGame extends BaseGame<ConfigurableGameState> {
  ...
  constructor(
    ...
    this.valueResolver = new ValueResolver(this.gameState, this.config.gameData, this.players, this.hostId);
    this.effectExecutor = new EffectExecutor(this.gameState, this.config, this.valueResolver, this.handleInternalAction.bind(this));
